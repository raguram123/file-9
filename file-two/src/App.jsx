  ...
  return (
    <>
      ...
      <div className="container mt-md-5">
        ...
        <h1 className="text-center mt-2 text-info" id="tittle">
           Todo List
        </h1>
        <form>
          <div className="input-group mb-3">
            <input
              type="text"
              className="my-4 rounded-3 border-info form-control"
              value={taskName}
            ...
            <input
              type="text"
              class=" mx-5 my-4 rounded-3 border-info form-control"
            ...
            <button
              class="btn bg-info btn-primary px-5 my-4 rounded-3"
              onClick={addTodo}
            >
        ...
        <div className="input-group">
          ...
          <div className="ms-auto">
            ...
            >
              ...
              <option
                value="Completed"
                className="complete bg-success text-black"
              >
                Completed
              </option>
              <option value="Not Completed" className="bg-danger text-black">
                Not Completed
              </option>
            </select>
          </div>
